...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // ==========================
  const products = [
    { id: 1, name: "4 pcs Ethiopian Opal | 35 ct (7.00 g) | Oval Cabochon | ~12 × 9 × 5 mm avg | Multicolor |shipped", price:330.00, image: "images/2.png", video: `${BACKEND_URL}/videos/1.mp4` },
